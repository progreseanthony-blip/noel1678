...
class ProjectPickerPage extends StatefulWidget {
  ...
  final String Function(String projectId) routeBuilder;
      ...
      body: Row(children: [
        ...
        Expanded(
          child: Column(children: [
            if (!isMobile)
              TopHeader(userName: userName, breadcrumbs: widget.breadcrumbs),
            if (isMobile)
  ...
  Widget _buildMobileHeader(String userName) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text(widget.title, style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.slate900)),
      ]),
    );
  }
  ...
  Widget _emptyState() {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(widget.icon, size: 64, color: AppTheme.slate400),
        ...
        Text(widget.emptyMessage, style: GoogleFonts.manrope(color: AppTheme.slate400)),
      ]),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.push(widget.routeBuilder(p['id'] as String)),
            ...
            child: Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: Icon(widget.icon, color: AppTheme.primaryGreen, size: 24),
                ),
                ...
                Text(widget.actionLabel, style: GoogleFonts.manrope(fontSize: 13, color: AppTheme.primaryGreen, fontWeight: FontWeight.w600)),
