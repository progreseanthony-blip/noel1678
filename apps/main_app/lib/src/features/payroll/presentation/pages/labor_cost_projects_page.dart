...
class LaborCostProjectsPage extends StatefulWidget {
  const LaborCostProjectsPage({super.key});

  @override
  State<LaborCostProjectsPage> createState() => _LaborCostProjectsPageState();
}

class _LaborCostProjectsPageState extends State<LaborCostProjectsPage> {
  ...
  Widget _buildMobileHeader(String userName) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text('Labor Cost', style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.slate900)),
      ]),
    );
  }
  ...
  Widget _emptyState() {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text('Create a project to start tracking labor costs.', style: GoogleFonts.manrope(color: AppTheme.slate400)),
      ]),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.push('/projects/${p['id']}/payroll'),
            ...
            child: Padding(
              ...
              child: Row(children: [
                ...
                Text('View Labor Cost', style: GoogleFonts.manrope(fontSize: 13, color: AppTheme.primaryGreen, fontWeight: FontWeight.w600)),
