...
class ReceptionProjectsPage extends StatefulWidget {
  const ReceptionProjectsPage({super.key});

  @override
  State<ReceptionProjectsPage> createState() => _ReceptionProjectsPageState();
}

class _ReceptionProjectsPageState extends State<ReceptionProjectsPage> {
      ...
      body: Row(children: [
        ...
        Expanded(
          child: Column(children: [
            if (!isMobile)
              TopHeader(userName: userName, breadcrumbs: const ['Operations', 'Projects', 'Reception']),
            if (isMobile)
  ...
  Widget _buildMobileHeader(String userName) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text('Reception', style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.slate900)),
      ]),
    );
  }
  ...
  Widget _emptyState() {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.inventory, size: 64, color: AppTheme.slate400),
        ...
        Text('Create a project to manage reception.', style: GoogleFonts.manrope(color: AppTheme.slate400)),
      ]),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.go('/projects/${p['id']}/reception'),
            ...
            child: Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.inventory, color: AppTheme.primaryGreen, size: 24),
                ),
                ...
                Text('View Reception', style: GoogleFonts.manrope(fontSize: 13, color: AppTheme.primaryGreen, fontWeight: FontWeight.w600)),
