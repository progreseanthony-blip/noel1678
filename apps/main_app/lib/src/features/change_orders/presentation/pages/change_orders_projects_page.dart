...
class ChangeOrdersProjectsPage extends StatefulWidget {
  const ChangeOrdersProjectsPage({super.key});

  @override
  State<ChangeOrdersProjectsPage> createState() => _ChangeOrdersProjectsPageState();
}

class _ChangeOrdersProjectsPageState extends State<ChangeOrdersProjectsPage> {
      ...
      body: Row(children: [
        ...
        Expanded(
          child: Column(children: [
            if (!isMobile)
              TopHeader(userName: userName, breadcrumbs: const ['Projects', 'Change Orders']),
            if (isMobile)
  ...
  Widget _buildMobileHeader(String userName) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text('Change Orders', style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.slate900)),
      ]),
    );
  }
  ...
  Widget _emptyState() {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.swap_horizontal_circle_outlined, size: 64, color: AppTheme.slate400),
        ...
        Text('Select a project to manage change orders.', style: GoogleFonts.manrope(color: AppTheme.slate400)),
      ]),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.go('/projects/${p['id']}/change-orders'),
            ...
            child: Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.swap_horizontal_circle_outlined, color: AppTheme.primaryGreen, size: 24),
                ),
                ...
                Text('View Change Orders', style: GoogleFonts.manrope(fontSize: 13, color: AppTheme.primaryGreen, fontWeight: FontWeight.w600)),
