...
class ProductionMeasurementProjectsPage extends StatefulWidget {
  const ProductionMeasurementProjectsPage({super.key});

  @override
  State<ProductionMeasurementProjectsPage> createState() => _ProductionMeasurementProjectsPageState();
}

class _ProductionMeasurementProjectsPageState extends State<ProductionMeasurementProjectsPage> {
      ...
      body: Row(children: [
        ...
        Expanded(
          child: Column(children: [
            if (!isMobile)
              TopHeader(userName: userName, breadcrumbs: const ['Projects', 'Production Metrics']),
            if (isMobile)
  ...
  Widget _buildMobileHeader(String userName) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text('Production Metrics', style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.slate900)),
      ]),
    );
  }
  ...
  Widget _emptyState() {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.speed, size: 64, color: AppTheme.slate400),
        ...
        Text('Create a project and submit daily reports to see production metrics.', style: GoogleFonts.manrope(color: AppTheme.slate400)),
      ]),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.push('/projects/${p['id']}/production-measurement'),
            ...
            child: Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.speed, color: AppTheme.primaryGreen, size: 24),
                ),
                ...
                Text('View Metrics', style: GoogleFonts.manrope(fontSize: 13, color: AppTheme.primaryGreen, fontWeight: FontWeight.w600)),
